            ...
            <Card className="max-w-2xl mx-auto mt-12">
              <CardContent className="p-8 text-center">
                ...
                <div className="flex gap-4 justify-center flex-wrap">
                  ...
                  <a href={`https://wa.me/233201578429?text=${encodeURIComponent("Hi Dwellot! I have a question that isn't covered in your FAQ.")}`} target="_blank" rel="noopener noreferrer">
